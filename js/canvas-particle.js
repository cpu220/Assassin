var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var itemObj = getELementById(canvasConfig.id);
    ...
    itemObj.style.padding = "0";
    itemObj.style.margin = "0";
		// body.replaceChild(canvas.element, canvasDiv);
    itemObj.appendChild(canvas.element);

		canvas.element.style = "position: absolute; top: 0; left: 0; z-index: 1;";
		canvasSize(itemObj,canvas.element);
		window.onresize = function(){
			canvasSize(itemObj,canvas.element);
		}
    itemObj.onmousemove = function(e){
	...
	// 设置canvas大小
	function canvasSize(item,canvas){
